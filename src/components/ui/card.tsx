...
>(({ className, children, ...props }, ref) => (
  // Use h3 or similar heading tag for semantic correctness
  <h3
    ref={ref}
    className={cn(
...
const CardContent = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  // Changed default padding to p-6 and pt-0 to just p-6 for broader use,
  // then removed pt-0 specifically. Consumers can add specific padding.
